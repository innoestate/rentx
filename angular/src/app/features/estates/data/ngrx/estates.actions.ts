...
export const createEstate = createAction('[Estates] Create Estate', props<{ estate: Partial<Estate_Dto> | any }>());
...
export const editEstateSuccess = createAction('[Estates] Edit Estate Success', props<{ estate: Partial<Estate> }>());
