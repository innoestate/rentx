...
import { catchError, delay, filter, lastValueFrom, of, switchMap, take, tap } from "rxjs";
...
export class EstatesCommandsService {
  ...
  createEstate() {
    ...
    this.popupService.openContinuableFormPopup<Estate>(action, 'Ajouter un propriétaire', createEstateFieldsDataPopup);
