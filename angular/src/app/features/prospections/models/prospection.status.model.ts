...
export const PROSPECTION_STATUS: ProspectionStatus[] = [
  ...
  { key: "Scheduled", label: "Visite planifiée", shortLabel: "à visiter", color: "var(--rentx-prospection-color-scheduled)", colorLight: "var(--rentx-prospection-color-scheduled-active)", icon: PropertyStatusIcons.Scheduled, iconTheme: "fill" },
  { key: "Visited", label: "Visite effectuée", shortLabel: "visité", color: "var(--rentx-prospection-color-visited)", colorLight: "var(--rentx-prospection-color-visited-active)", icon: PropertyStatusIcons.Visited, iconTheme: "fill" },
  ...
  { key: "Signed", label: "Compromis de vente signé", shortLabel: "signé", color: "var(--rentx-prospection-color-signed)", colorLight: "var(--rentx-prospection-color-signed-active)", icon: PropertyStatusIcons.Signed, iconTheme: "outline" },
  ...
  { key: "UnderContract", label: "Bien sous compromis de vente", shortLabel: "compromis tiers", color: "var(--rentx-prospection-color-undercontract", colorLight: "var(--rentx-prospection-color-undercontract-active)", icon: PropertyStatusIcons.UnderContract, iconTheme: "outline" },
  { key: "Sold", label: "Bien vendu", shortLabel: "vendu", color: "var(--rentx-prospection-color-sold)", colorLight: "var(--rentx-prospection-color-sold-active)", icon: PropertyStatusIcons.Sold, iconTheme: "fill" },
]
