...
describe('test dates after a fusion of rents in multiple estates', () => {
    ...
    it('test of 2 rents in 2 differents estates', () => {
        const rents = fusionateRents([{...rent2023_12}, {...rent1Estate2}]);
    ...
    it('should return 3 rents in 2 different estates', () => {
        const rents = fusionateRents([{...rent2023_12}, {...rent1Estate2}, {...rent2021_02}]);
        expect(rents.length).toEqual(3);
        expect(rents[0].start_date.toISOString()).toEqual(rent2023_12.start_date.toISOString());
    ...
    it('should return 3 rents in 2 different estates', () => {
        const rents = fusionateRents([{...rent2023_12}, {...rent2021_01}, {...rent1Estate2}, {...rent2021_02}]);
        expect(rents.length).toEqual(2);
        expect(rents[0].start_date.toISOString()).toEqual(rent2023_12.start_date.toISOString());
